...
const TAG_WORDS = {
  ru: ["продают", "конвертят", "впечатляют", "зарабатывают"],
  en: ["sell", "convert", "impress", "earn"],
};
    ...
    <div className="min-h-screen select-none overflow-x-hidden showcase-page" style={{ backgroundColor: '#050505' }}>
      ...
      <div className="relative z-10">
        ...
        <div className="mx-auto w-full" style={{ maxWidth: 540 }}>
          ...
          <header ref={heroRef} className="relative px-6 pt-16 pb-14 overflow-hidden" role="banner">
            <div className="absolute inset-0 z-0 overflow-hidden">
              <div
                className="showcase-orb-1 absolute rounded-full"
                style={{
                  width: 400, height: 400, top: '-10%', left: '-20%',
                  background: `radial-gradient(circle, ${EMERALD}30 0%, ${EMERALD}0a 50%, transparent 70%)`,
                  filter: 'blur(80px)',
                }}
              />
              <div
                ...
                style={{
                  ...
                  background: 'radial-gradient(circle, rgba(168,85,247,0.22) 0%, rgba(168,85,247,0.04) 50%, transparent 70%)',
                  filter: 'blur(70px)',
                }}
              />
              <div
                ...
                style={{
                  width: 250, height: 250, bottom: '-5%', left: '20%',
            ...
            <m.div className="relative z-10" style={{ y: reducedMotion ? 0 : heroY, opacity: reducedMotion ? 1 : heroOpacity }}>
              ...
              <m.div
                ...
                transition={{ duration: reducedMotion ? 0 : 0.5, ease: EASE, delay: reducedMotion ? 0 : 0.2 }}
                className="mb-8"
              >
                <span
                  ...
                  style={{
                    ...
                    boxShadow: `0 0 30px ${EMERALD}0a, inset 0 0 20px ${EMERALD}05`,
                  }}
                >
                  ...
                  <span style={{
                    ...
                    {ru ? '22 приложения запущены' : '22 apps live'}
                  </span>
                </span>
              </m.div>
              ...
              <m.div
                ...
                animate={{ opacity: 1 }}
                transition={{ duration: reducedMotion ? 0 : 0.3, delay: reducedMotion ? 0 : 0.35 }}
                className="mb-5"
              >
                <div className="h-px w-12" style={{ background: `linear-gradient(to right, ${EMERALD}, transparent)` }} aria-hidden="true" />
              </m.div>
              ...
              <m.h1
                ...
                style={{ fontFamily: SYNE, letterSpacing: '-0.06em' }}
              >
                <m.span
                  className="block"
                  initial={reducedMotion ? { opacity: 1 } : { opacity: 0, y: 40 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: reducedMotion ? 0 : 0.7, ease: EASE, delay: reducedMotion ? 0 : 0.45 }}
                  style={{ fontSize: 'clamp(2.5rem, 10vw, 4rem)', fontWeight: 800, color: '#fff', lineHeight: 0.95 }}
                >
                  {ru ? 'Мы создаём' : 'We build'}
                </m.span>
                <m.span
                  className="block"
                  initial={reducedMotion ? { opacity: 1 } : { opacity: 0, y: 40 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: reducedMotion ? 0 : 0.7, ease: EASE, delay: reducedMotion ? 0 : 0.55 }}
                  style={{
                    fontSize: 'clamp(2.5rem, 10vw, 4rem)', fontWeight: 800, lineHeight: 0.95,
                    color: 'rgba(255,255,255,0.25)',
                  }}
                >
                  {ru ? 'приложения' : 'apps that'}
                </m.span>

                <span className="block overflow-hidden mt-1" style={{ height: 'clamp(2.8rem, 11vw, 4.5rem)' }}>
                  <AnimatePresence mode="wait">
                    <m.span
                      ...
                      style={{
                        fontSize: 'clamp(2.5rem, 10vw, 4rem)', fontWeight: 800,
                        fontFamily: SYNE, lineHeight: 0.95,
              ...
              <m.p
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: reducedMotion ? 0 : 0.6, ease: EASE, delay: reducedMotion ? 0 : 0.9 }}
                className="mt-8"
                style={{
                  maxWidth: 340,
                  fontFamily: INTER, fontSize: 'clamp(0.85rem, 2.2vw, 1rem)',
                  lineHeight: 1.65, color: 'rgba(255,255,255,0.5)', fontWeight: 400,
                }}
              >
                {ru
                  ? 'Telegram Mini Apps для e-commerce. Ноль комиссий маркетплейсов. Запуск за 24 часа.'
                  : 'Telegram Mini Apps for e-commerce. Zero marketplace fees. Launch in 24 hours.'}
              </m.p>

              <m.div
                initial={reducedMotion ? { opacity: 1 } : { opacity: 0, y: 15 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: reducedMotion ? 0 : 0.5, ease: EASE, delay: reducedMotion ? 0 : 1.1 }}
                className="mt-8 flex items-center gap-5"
              >
                <div className="relative">
                  <div className="absolute -inset-2 rounded-full showcase-cta-glow" style={{
                    background: `linear-gradient(135deg, ${EMERALD}25, rgba(168,85,247,0.12))`,
                    filter: 'blur(14px)',
                  }} />
                  <button
                    onClick={() => nav('projects')}
                    className="relative group flex items-center gap-2.5 rounded-full px-7 transition-all duration-500 active:scale-[0.96] focus-visible:outline focus-visible:outline-2 focus-visible:outline-white/60 focus-visible:outline-offset-2"
                ...
                <button
                  ...
                  className="group flex items-center gap-1.5 transition-opacity duration-300 active:opacity-60 focus-visible:outline focus-visible:outline-2 focus-visible:outline-white/40 focus-visible:outline-offset-2 rounded"
                  aria-label={ru ? 'Посмотреть демо' : 'View demo'}
                >
                  <span style={{
                    fontFamily: INTER, fontSize: 'clamp(0.75rem, 1.6vw, 0.8125rem)',
                    fontWeight: 500, color: 'rgba(255,255,255,0.5)',
                  }}>
                    {ru ? 'Смотреть демо' : 'View Demo'}
                  </span>
                  <ChevronRight className="w-3.5 h-3.5 transition-transform duration-300 group-hover:translate-x-0.5" style={{ color: 'rgba(255,255,255,0.4)' }} />
                </button>
              </m.div>
              ...
              >
                {[
                  { v: '900M+', l: ru ? 'аудитория' : 'audience' },
                  { v: '0%', l: ru ? 'комиссий' : 'fees' },
                  { v: '24h', l: ru ? 'запуск' : 'launch' },
                ].map((s, i) => (
                  <div key={i} className="flex items-baseline gap-1.5">
                    <span style={{
                      fontFamily: SYNE, fontSize: 'clamp(0.875rem, 2.5vw, 1.125rem)',
                      fontWeight: 800, letterSpacing: '-0.03em',
                      color: i === 0 ? '#fff' : 'rgba(255,255,255,0.7)',
                    }}>{s.v}</span>
                    <span style={{
                      fontFamily: INTER, fontSize: '0.625rem',
          ...
          <div className="py-5 overflow-hidden relative" style={{ borderTop: '1px solid rgba(255,255,255,0.06)', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
            <div className="absolute inset-x-0 top-0 h-px" style={{ background: `linear-gradient(to right, transparent, ${EMERALD}15, transparent)` }} aria-hidden="true" />
            <div className="absolute inset-x-0 bottom-0 h-px" style={{ background: `linear-gradient(to right, transparent, ${EMERALD}15, transparent)` }} aria-hidden="true" />
            <m.div
          ...
          <section className="px-6 py-20 relative" aria-label={ru ? 'Метрики' : 'Metrics'}>
            <div className="absolute inset-0 pointer-events-none overflow-hidden" aria-hidden="true">
              <div className="showcase-orb-3 absolute rounded-full"
                style={{ width: 200, height: 200, top: '20%', left: '-20%', background: `radial-gradient(circle, ${EMERALD}0a 0%, transparent 60%)`, filter: 'blur(50px)' }}
              />
            </div>
                ...
                <Cin key={i} delay={i * 0.06}>
                  <div>
                    <div style={{
                      ...
                      ...(i === 0
                        ? { background: `linear-gradient(135deg, #fff, ${EMERALD})`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }
                  ...
                  <AnimatePresence initial={false}>
                    {visibleCards.map((card, index) => {
                      ...
                      return (
                        ...
                        >
                          <article
                            className="relative overflow-hidden rounded-2xl cursor-pointer group active:scale-[0.98] transition-all duration-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-white/60 focus-visible:outline-offset-2 showcase-glass-card"
                            style={{
                              height: 320,
                            }}
                            role="button"
              ...
              {([
                ...
                return (
                  <Cin key={i} delay={i * 0.04} className={f.span}>
                    <div
                      className="rounded-2xl p-4 group showcase-glass-card"
                    >
          ...
          <section className="px-6 py-16" aria-label={ru ? 'Процесс' : 'Process'}>
            ...
            <div className="relative">
              <div className="absolute left-[1.35rem] top-4 bottom-4 w-px showcase-process-line"
                style={{ background: `linear-gradient(to bottom, ${EMERALD}30, ${EMERALD}08)` }}
                aria-hidden="true"
              />
              ...
              {[
                ...
                <Cin key={i} delay={i * 0.08}>
                  <div className="flex items-start gap-5 mb-9 last:mb-0 relative">
                    <div className="relative flex flex-col items-center">
                      <div className="w-11 h-11 rounded-full flex items-center justify-center"
                        style={{
                          background: i === 2 ? `${EMERALD}15` : 'rgba(255,255,255,0.04)',
                          border: `1px solid ${i === 2 ? `${EMERALD}30` : 'rgba(255,255,255,0.06)'}`,
                          boxShadow: i === 2 ? `0 0 20px ${EMERALD}15` : 'none',
                        }}>
                        <span style={{
                          fontFamily: SYNE, fontSize: '0.75rem',
                          fontWeight: 800, letterSpacing: '-0.03em',
                          color: i === 2 ? EMERALD : 'rgba(255,255,255,0.3)',
                        }}>{s.n}</span>
                      </div>
                    </div>
                    <div className="pt-2">
          ...
          <section className="px-6 py-20 relative" aria-label={ru ? 'Отзывы' : 'Testimonials'}>
            <div className="absolute inset-0 pointer-events-none overflow-hidden" aria-hidden="true">
              <div className="showcase-orb-2 absolute rounded-full"
                style={{ width: 180, height: 180, top: '30%', right: '-15%', background: `radial-gradient(circle, ${EMERALD}08 0%, transparent 60%)`, filter: 'blur(40px)' }}
              />
            </div>
            <Cin>
              <div className="rounded-2xl p-6 mb-10 showcase-glass-card" style={{ background: 'rgba(52,211,153,0.04)', border: '1px solid rgba(52,211,153,0.1)' }}>
          ...
          <section className="px-6 pt-8 pb-10" aria-label="CTA">
            <Cin>
              <div className="relative overflow-hidden rounded-3xl py-16 px-7 text-center showcase-glass-card" style={{ border: '1px solid rgba(52,211,153,0.08)' }}>
                <div className="absolute inset-0 pointer-events-none showcase-cta-glow" style={{
                  background: `radial-gradient(ellipse at 50% 100%, ${EMERALD}15 0%, transparent 60%)`,
                }} />
                <div className="absolute inset-0 pointer-events-none" style={{
                  background: `radial-gradient(ellipse at 20% 20%, rgba(168,85,247,0.04) 0%, transparent 50%), radial-gradient(ellipse at 80% 80%, ${EMERALD}06 0%, transparent 50%)`,
                }} />
                ...
                <div className="relative z-10">
                  ...
                  <p className="mt-4 mx-auto" style={{
                    maxWidth: 280,
                    fontFamily: INSTRUMENT, fontSize: 'clamp(0.9rem, 2.2vw, 1.1rem)',
                    fontStyle: 'italic', color: 'rgba(255,255,255,0.5)', lineHeight: 1.5,
                  }}>
                  ...
                  <div className="relative inline-block mt-8">
                    <div className="absolute -inset-1 rounded-full showcase-cta-glow" style={{
                      background: `linear-gradient(135deg, ${EMERALD}40, rgba(168,85,247,0.2))`,
                      filter: 'blur(12px)',
                    }} />
                    <button
                      onClick={() => nav('projects')}
                      className="relative inline-flex items-center gap-2.5 rounded-full px-8 transition-all duration-500 active:scale-[0.96] focus-visible:outline focus-visible:outline-2 focus-visible:outline-white/60 focus-visible:outline-offset-2"
                      style={{ height: 52, background: '#fff' }}
                    >
                      <span style={{ fontFamily: SYNE, fontSize: '0.875rem', fontWeight: 700, color: '#000' }}>
