...
const demoThemes: Record<string, Partial<DemoTheme>> = {
  ...
  'clothing-store': { background: '#EEEAE2', isDark: false, accent: '#A65A33', onAccent: '#FFFFFF' },
  'premium-fashion': { background: '#EEEAE2', isDark: false, accent: '#A65A33', onAccent: '#FFFFFF' },
