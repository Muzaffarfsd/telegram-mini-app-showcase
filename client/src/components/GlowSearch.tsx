  ...
  return (
    <>
      <style>{`
        ...
        .glow-search-input::placeholder {
          color: #c0b9c0;
        }
        
        .glow-search-input:focus {
          outline: none;
        }
        
        .glow-search-main:focus-within > .glow-search-input-mask {
          display: none;
        }
        
        .glow-search-input-mask {
          pointer-events: none;
          width: 100px;
          height: 20px;
          position: absolute;
        ...
        .glow-search-darkBorderBg::before {
          content: "";
          z-index: -2;
          text-align: center;
          top: 50%;
        ...
        .glow-search-filter-border::before {
          content: "";
          text-align: center;
          top: 50%;
          left: 50%;
