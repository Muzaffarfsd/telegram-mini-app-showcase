...
function LabSurvivalist({ activeTab }: LabSurvivalistProps) {
  ...
  if (activeTab === 'catalog' && selectedProduct) {
    ...
    return (
      <div className="min-h-screen text-white overflow-auto smooth-scroll-page" data-scroll="demo-lab-survivalist" style={{ backgroundColor: bgColor }}>
  ...
  if (activeTab === 'home') {
    return (
      <div className="min-h-screen bg-black text-white overflow-auto pb-24 smooth-scroll-page" data-scroll="demo-lab-survivalist">
  ...
  if (activeTab === 'cart') {
    ...
    return (
      <div className="min-h-screen bg-black text-white overflow-auto pb-32 smooth-scroll-page" data-scroll="demo-lab-survivalist">
        <div className="p-6">
