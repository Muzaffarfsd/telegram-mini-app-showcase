...
export default function InteriorLux({ activeTab }: InteriorLuxProps) {
  ...
  const renderHomeTab = () => (
    <div className="min-h-screen bg-white font-montserrat pb-24 smooth-scroll-page" data-scroll="demo-interior-lux">
  ...
  const renderCatalogTab = () => (
    <div className="min-h-screen bg-gray-50 font-montserrat pb-24 smooth-scroll-page" data-scroll="demo-interior-lux">
