...
function FragranceRoyale({ activeTab }: FragranceRoyaleProps) {
  ...
  if (activeTab === 'catalog' && selectedPerfume) {
    ...
    return (
      <div className="min-h-screen text-white overflow-auto pb-24 smooth-scroll-page" data-scroll="demo-fragrance-royale" style={{ backgroundColor: bgColor }}>
  ...
  if (activeTab === 'home') {
    return (
      <div className="min-h-screen bg-[#0A0A0A] text-white overflow-auto pb-24 smooth-scroll-page" data-scroll="demo-fragrance-royale">
  ...
  if (activeTab === 'cart') {
    ...
    return (
      <div className="min-h-screen bg-[#0A0A0A] text-white overflow-auto pb-32 smooth-scroll-page" data-scroll="demo-fragrance-royale">
        <div className="p-6">
