...
const perfumes: Perfume[] = [
  { 
    ...
    description: 'Загадочная роскошь. Чёрная орхидея сплетается с тёмным шоколадом и пачули.',
  ...
  { 
    ...
    description: 'Аромат победителей. Дымный ананас встречает бёрский мускус и дубовый мох.',
  ...
  { 
    ...
    description: 'Вечная классика. Майская роза и жасмин в объятиях альдегидов.',
  ...
  { 
    ...
    description: 'Культовый минимализм. Австралийский сандал и кожа у потухшего костра.',
  ...
  { 
    ...
    description: 'Алхимия света. Шафран и амбровое дерево в сиянии хрусталя Baccarat.',
  ...
  { 
    ...
    description: 'Древний восток. Редкий агаровый уд сплетён с палисандром и кардамоном.',
  ...
  { 
    ...
    description: 'Дикая свобода. Калабрийский бергамот разбивается о амброксан пустыни.',
  ...
  { 
    ...
    description: 'Дерзкая элегантность. Сицилийский апельсин танцует с турецкой розой и пачули.',
