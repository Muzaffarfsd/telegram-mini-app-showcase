...
const services: Service[] = [
  {
    ...
    price: 2500,
    image: 'https://images.unsplash.com/photo-1562322140-8baeececf3df?w=800&h=1200&fit=crop&q=90',
    description: 'Индивидуальный подход. Премиум косметика. Безупречный результат.',
    category: 'Парикмахерские',
    duration: '60 мин',
    specialist: 'Анна Смирнова',
    rating: 4.9,
    isPopular: true,
    benefits: ['Профессиональная консультация', 'Анализ типа волос', 'Укладка включена'],
    process: 'Консультация → Мытье → Стрижка → Укладка',
    aftercare: 'Рекомендуем стайлинг средства для фиксации'
  },
  {
    id: 2,
    ...
    description: 'Роскошный цвет. Щадящие формулы. Сияние надолго.',
    category: 'Парикмахерские',
    duration: '180 мин',
    specialist: 'Елена Козлова',
    rating: 4.8,
    isPopular: true,
    benefits: ['Краски без аммиака', 'Защита волос', 'Глубокий уход'],
    process: 'Диагностика → Подбор оттенка → Нанесение → Уход',
    aftercare: 'Используйте бессульфатные шампуни для сохранения цвета'
  },
  {
    id: 3,
    name: 'Балаяж',
    price: 8900,
    image: 'https://images.unsplash.com/photo-1522337094846-8a818192de1f?w=800&h=1200&fit=crop&q=90',
    description: 'Естественные переходы. Солнечные блики. Трендовая техника.',
    category: 'Парикмахерские',
    duration: '240 мин',
    ...
    isNew: true,
    isPopular: true,
    benefits: ['Авторская техника', 'Натуральный эффект', 'Длительный результат'],
    process: 'Консультация → Подготовка → Осветление → Тонирование → Уход',
    aftercare: 'Используйте оттеночные маски для поддержания тона'
  },
  {
    id: 4,
    name: 'Маникюр + гель-лак',
    price: 1900,
    image: 'https://images.unsplash.com/photo-1632345031435-8727f6897d53?w=800&h=1200&fit=crop&q=90',
    description: 'Безупречное покрытие. Стойкий блеск. Забота о ногтях.',
    category: 'Маникюр',
    duration: '90 мин',
    specialist: 'Ольга Иванова',
    rating: 4.8,
    isPopular: true,
    benefits: ['Премиум гель-лаки', 'Стойкость до 3 недель', 'Укрепление ногтей'],
    process: 'Снятие → Обработка → Покрытие → Сушка',
    aftercare: 'Наносите масло для кутикулы ежедневно'
  },
  {
    id: 5,
    name: 'Френч маникюр',
    ...
    description: 'Классическая элегантность. Идеальная линия улыбки. Утончённость.',
    category: 'Маникюр',
    duration: '75 мин',
    specialist: 'Наталья Волкова',
    rating: 4.9,
    benefits: ['Укрепление ногтевой пластины', 'Ручная прорисовка', 'Натуральный вид'],
    process: 'Подготовка → Формирование → Френч → Топовое покрытие',
    aftercare: 'Избегайте контакта с бытовой химией без перчаток'
  },
  {
    id: 6,
    name: 'Дизайн ногтей',
    ...
    description: 'Авторский дизайн. Креативные решения. Уникальный образ.',
    category: 'Маникюр',
    duration: '120 мин',
    specialist: 'Дарья Кузнецова',
    rating: 4.7,
    benefits: ['Индивидуальный эскиз', 'Премиум материалы', 'Художественная роспись'],
    process: 'Консультация → Эскиз → Маникюр → Дизайн → Закрепление',
    aftercare: 'Бережное обращение в первые 24 часа'
  },
  {
    id: 7,
    name: 'СПА педикюр',
    price: 3200,
    image: 'https://images.unsplash.com/photo-1598256989800-fe5f95da9787?w=800&h=1200&fit=crop&q=90',
    description: 'Глубокое расслабление. Мягкость кожи. Абсолютный комфорт.',
    category: 'Педикюр',
    duration: '100 мин',
    ...
    process: 'Ванночка → Пилинг → Обработка → Массаж → Покрытие',
    aftercare: 'Наносите увлажняющий крем для стоп перед сном'
  },
  {
    id: 8,
    name: 'Аппаратный педикюр',
    price: 2800,
    image: 'https://images.unsplash.com/photo-1587662784763-0021b5f0b1b7?w=800&h=1200&fit=crop&q=90',
    description: 'Безопасная технология. Идеальная гладкость. Профессиональный уход.',
    category: 'Педикюр',
    duration: '80 мин',
    specialist: 'Татьяна Морозова',
    rating: 4.8,
    benefits: ['Стерильность', 'Без размачивания', 'Деликатная обработка'],
    process: 'Осмотр → Аппаратная обработка → Полировка → Покрытие',
    aftercare: 'Используйте кератолитики для поддержания результата'
  },
  {
    id: 9,
    name: 'Чистка лица',
    ...
    description: 'Глубокое очищение. Сияющая кожа. Профессиональный протокол.',
    category: 'Косметология',
    duration: '90 мин',
    specialist: 'Юлия Титова',
    rating: 4.8,
    isPopular: true,
    benefits: ['Диагностика кожи', 'Ультразвук', 'Увлажняющая маска'],
    process: 'Демакияж → Распаривание → Чистка → Маска → Финиш',
    aftercare: 'Избегайте декоративной косметики 24 часа'
  },
  {
    id: 10,
    name: 'Химический пилинг',
    price: 5500,
    image: 'https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?w=800&h=1200&fit=crop&q=90',
    description: 'Обновление кожи. Выравнивание тона. Молодость изнутри.',
    category: 'Косметология',
    duration: '60 мин',
    specialist: 'Анна Соколова',
    rating: 4.7,
    benefits: ['Медицинские препараты', 'Индивидуальный протокол', 'Видимый результат'],
    process: 'Подготовка → Нанесение состава → Нейтрализация → Уход',
    aftercare: 'Обязательно используйте SPF 50+ в течение 2 недель'
  },
  {
    id: 11,
    name: 'Массаж лица',
    ...
    description: 'Лифтинг-эффект. Расслабление мышц. Естественное сияние.',
    category: 'Косметология',
    duration: '45 мин',
    specialist: 'Валентина Крылова',
    rating: 4.6,
    isNew: true,
    benefits: ['Премиум сыворотки', 'Техника буккального массажа', 'Моментальный эффект'],
    process: 'Очищение → Массаж → Сыворотка → Маска',
    aftercare: 'Пейте больше воды для закрепления результата'
  },
  {
    id: 12,
    name: 'Ботокс для волос',
    price: 7500,
    image: 'https://images.unsplash.com/photo-1522338242992-e1a54906a8da?w=800&h=1200&fit=crop&q=90',
    description: 'Интенсивное восстановление. Зеркальный блеск. Шелковистость.',
    category: 'Парикмахерские',
    duration: '120 мин',
    specialist: 'Анна Смирнова',
    rating: 4.9,
    isNew: true,
    benefits: ['Глубокое питание', 'Устранение пушистости', 'Термозащита'],
    process: 'Мытье → Нанесение состава → Выдержка → Запечатывание → Укладка',
    aftercare: 'Используйте безсульфатный уход для продления эффекта'
  },
  {
    id: 13,
    name: 'Наращивание ресниц',
    price: 4900,
    image: 'https://images.unsplash.com/photo-1583001931096-959e90c3d930?w=800&h=1200&fit=crop&q=90',
    description: 'Выразительный взгляд. Премиум материалы. Естественная красота.',
    category: 'Косметология',
    duration: '150 мин',
    specialist: 'Ирина Павлова',
    rating: 4.8,
    benefits: ['Гипоаллергенные материалы', 'Объём 2D-3D', 'Комфортная носка'],
    process: 'Подготовка → Подбор эффекта → Наращивание → Закрепление',
    aftercare: 'Избегайте масляных средств и механического воздействия'
  },
  {
    id: 14,
    ...
    description: 'Роскошный образ. Стойкая фиксация. Идеально для торжества.',
    category: 'Парикмахерские',
    duration: '90 мин',
    specialist: 'Мария Петрова',
    rating: 4.7,
    benefits: ['Консультация по образу', 'Премиум стайлинг', 'Долгая фиксация'],
    process: 'Мытье → Сушка → Создание формы → Декорирование → Фиксация',
    aftercare: 'Используйте сухой шампунь для освежения на следующий день'
  },
  {
    id: 15,
    name: 'Массаж тела',
    ...
    description: 'Полное расслабление. Снятие напряжения. Гармония тела и разума.',
    category: 'Массаж',
    duration: '60 мин',
    specialist: 'Ольга Смирнова',
    rating: 4.9,
    isPopular: true,
    benefits: ['Натуральные масла', 'Индивидуальная техника', 'Глубокая релаксация'],
    process: 'Подготовка → Разогрев → Основной массаж → Завершение',
    aftercare: 'Пейте больше воды и избегайте физических нагрузок'
  },
  {
    id: 16,
    ...
    description: 'Моделирование силуэта. Улучшение текстуры. Видимый результат.',
    category: 'Массаж',
    duration: '75 мин',
    specialist: 'Марина Белова',
    rating: 4.6,
    benefits: ['Разогревающие средства', 'Лимфодренаж', 'Курсовое лечение'],
    process: 'Разогрев → Активный массаж → Обёртывание → Завершение',
    aftercare: 'Соблюдайте водный режим и избегайте солёной пищи'
  },
];
