...
export default memo(function Electronics({ activeTab }: ElectronicsProps) {
  ...
  if (activeTab === 'catalog' && selectedProduct) {
    return (
      <div className="min-h-screen bg-[#0A0A0A] text-white overflow-auto pb-24 smooth-scroll-page" data-scroll="demo-electronics">
  ...
  if (activeTab === 'cart') {
    ...
    return (
      <div className="min-h-screen bg-[#0A0A0A] text-white overflow-auto pb-32 smooth-scroll-page" data-scroll="demo-electronics">
        <div className="p-6">
