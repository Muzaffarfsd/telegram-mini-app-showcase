...
function SneakerVault({ activeTab }: SneakerVaultProps) {
  ...
  if (activeTab === 'catalog' && selectedSneaker) {
    return (
      <div className="min-h-screen bg-[#0A0A0A] text-white overflow-auto pb-24 smooth-scroll-page" data-scroll="demo-sneaker-vault">
  ...
  if (activeTab === 'cart') {
    ...
    return (
      <div className="min-h-screen bg-[#0A0A0A] text-white overflow-auto pb-32 smooth-scroll-page" data-scroll="demo-sneaker-vault">
        <div className="p-6">
