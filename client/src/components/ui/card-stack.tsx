...
export function CardStack<T extends CardStackItem>({
  ...
  React.useEffect(() => {
    if (!autoAdvance || prefersReducedMotion || !len) return;
  ...
  }, [autoAdvance, intervalMs, hovering, pauseOnHover, prefersReducedMotion, len, loop, active, next]);
            ...
            {items.map((it, idx) => {
              ...
              return (
                <button
                  ...
                  style={{
                    background: on ? 'var(--text-primary, #fff)' : 'rgba(255,255,255,0.3)',
                  }}
      ...
      <div className="absolute inset-0">
        {item.imageSrc ? (
          ...
          <div
            ...
            style={{ background: 'var(--card-bg, #1a1a1a)', color: 'var(--text-tertiary, #999)' }}
          >
            No image
          </div>
        )}
