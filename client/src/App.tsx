...
function App() {
  ...
  // Fast path for showcase - skip heavy providers for instant first paint
  if (route.component === 'showcase') {
    return (
      <ErrorBoundary>
        <Suspense fallback={<ShowcaseShell />}>
          <HelmetProvider>
                      ...
                      <div className="relative min-h-screen">
                        ...
                        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 w-auto">
                          <div className="relative">
                            ...
                            >
                              <div className="absolute top-1 left-1/4 right-1/4 h-px bg-gradient-to-r from-transparent via-white/50 to-transparent rounded-full" />
                              <nav className="relative flex items-center justify-center gap-2" role="navigation" aria-label="Главное меню">
                                ...
                                >
                                  <Bot className="w-5 h-5 text-white/70 hover:text-white" strokeWidth={2} />
                                </button>
                                <button
                                ...
                                >
                                  <Briefcase className="w-5 h-5 text-white/70 hover:text-white" strokeWidth={2} />
                                </button>
                                <button
                                ...
                                >
                                  <ShoppingCart className="w-5 h-5 text-white/70 hover:text-white" strokeWidth={2} />
                                </button>
                                <button
                                ...
                                >
                                  <CircleUser className="w-5 h-5 text-white/70 hover:text-white" strokeWidth={2} />
                                </button>
                              </nav>
                            </div>
                          </div>
  ...
  // All other routes use full provider stack
  return (
    <ErrorBoundary>
      <HelmetProvider>
        <QueryClientProvider client={queryClient}>
