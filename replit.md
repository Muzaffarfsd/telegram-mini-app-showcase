...
- **ShowcasePage Design (Dec 2024)**: Ultra-premium Apple-style typography-first landing with AIDA headline ("Ваши клиенты уже в Telegram. А ваш бизнес?"), no hero video, dual CTAs (emerald primary + ghost secondary), metrics cards (50+ projects, 24h launch), static demo cards with image-only design, feature pills (AI/Payments/CRM/Automation), bottom emerald CTA. Color tokens: #0A0A0B background, #111113 cards, #10B981 emerald accent. Framer-motion fadeUp stagger animations.
